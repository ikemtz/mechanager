...
namespace IkeMtz.Mechanager.Inventory.OData.Controllers.V1
{
  ...
  public class PartsController : ODataController
  {
    ...
    public PartsController(IDatabaseContext databaseContext)
    {
    ...
    [ProducesResponseType(typeof(ODataEnvelope<Part, Guid>), Status200OK)]
    [EnableQuery(MaxTop = 100, AllowedQueryOptions = All)]
    public IEnumerable<Part> Get()
    {
      return _databaseContext.Parts
        .AsNoTracking();
    }
  }
}
